...
| `_calcIndicators` | 1846 | Вычисляет индикаторы по DATA |
| `buildBtCfg` | 2111 | Строит конфиг бэктеста из cfg+ind |
| `runMassRobust` | 2260 | Массовый тест устойчивости |
| `runRobustScoreFor` | 2326 | Тест устойчивости для одного результата |
| `runRobustScoreForDetailed` | 2493 | То же, но с деталями по каждому тесту |
| `HC_NUMERIC_PARAMS` | 2559 | Единый список числовых параметров HC |
