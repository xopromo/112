...
- `generatePineStrategy` (1906) — экспорт Pine стратегии (strategy.exit)
- `fixPineScript` (1915) — автоисправление Pine v5→v6
- `_addActivePinev6` (2031) — toggle-группы Pine v6
