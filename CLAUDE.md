...
| `runOOSScan` | 3001 | OOS-скан видимых результатов |
| `openHCModal` | 3194 | Открыть модал поиска соседей |
| `_hcRobScore` | 3293 | Робастность для GA-поиска |
| `_hcRunBacktest` | 3497 | Быстрый бэктест для HC (с кэшем `_robSliceCache`) |
| `_hcNeighbours` | 3684 | Генерация соседних cfg (содержит `mutate()`) |
| `runHillClimbing` | 3815 | Главный HC алгоритм |
| `_hcOpenDetail` | 4576 | Открыть детальный вид из HC модала |
