...
| `_calcIndicators` | 1812 | Вычисляет индикаторы по DATA |
| `buildBtCfg` | 2077 | Строит конфиг бэктеста из cfg+ind |
| `runMassRobust` | 2226 | Массовый тест устойчивости |
| `runRobustScoreFor` | 2292 | Тест устойчивости для одного результата |
| `runRobustScoreForDetailed` | 2459 | То же, но с деталями по каждому тесту |
| `HC_NUMERIC_PARAMS` | 2525 | Единый список числовых параметров HC |
