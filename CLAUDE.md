...
| `buildBtCfg` | 1983 | Строит конфиг бэктеста из cfg+ind |
| `runMassRobust` | 2130 | Массовый тест устойчивости |
| `runRobustScoreFor` | 2196 | Тест устойчивости для одного результата |
| `runRobustScoreForDetailed` | 2363 | То же, но с деталями по каждому тесту |
| `HC_NUMERIC_PARAMS` | 2429 | Единый список числовых параметров HC |
