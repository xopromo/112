...
| `_calcIndicators` | 1808 | Вычисляет индикаторы по DATA |
| `buildBtCfg` | 2061 | Строит конфиг бэктеста из cfg+ind |
| `runMassRobust` | 2210 | Массовый тест устойчивости |
| `runRobustScoreFor` | 2276 | Тест устойчивости для одного результата |
| `runRobustScoreForDetailed` | 2443 | То же, но с деталями по каждому тесту |
| `HC_NUMERIC_PARAMS` | 2509 | Единый список числовых параметров HC |
