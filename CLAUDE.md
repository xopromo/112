...
| `runOpt` | 443 | Основная оптимизация (MC/TPE/exhaustive) |
| `_runOOS` | 484 | Запуск бэктеста на срезе данных (внутри runOpt) |
| `_attachOOS` | 499 | Вычисляет IS/OOS split и прикрепляет к cfg._oos |
| `_calcIndicators` | 2087 | Вычисляет индикаторы по DATA |
| `buildBtCfg` | 2385 | Строит конфиг бэктеста из cfg+ind |
| `runMassRobust` | 2568 | Массовый тест устойчивости |
| `runRobustScoreFor` | 2634 | Тест устойчивости для одного результата |
| `runRobustScoreForDetailed` | 2801 | То же, но с деталями по каждому тесту |
| `HC_NUMERIC_PARAMS` | 2867 | Единый список числовых параметров HC |
...
| `fixPineScript` | 1147 | Автоисправление ошибок Pine |
| `_addActivePinev6` | 1263 | Добавляет `active=` для toggle-групп |
