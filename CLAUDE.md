...
| `buildBtCfg` | 2350 | Строит конфиг бэктеста из cfg+ind |
| `runMassRobust` | 2528 | Массовый тест устойчивости |
| `runRobustScoreFor` | 2594 | Тест устойчивости для одного результата |
| `runRobustScoreForDetailed` | 2761 | То же, но с деталями по каждому тесту |
| `HC_NUMERIC_PARAMS` | 2827 | Единый список числовых параметров HC |
