...
| `runOOSScan` | 2904 | OOS-скан видимых результатов |
| `openHCModal` | 3092 | Открыть модал поиска соседей |
| `_hcRobScore` | 3191 | Робастность для GA-поиска |
| `_hcRunBacktest` | 3395 | Быстрый бэктест для HC (с кэшем `_robSliceCache`) |
| `_hcNeighbours` | 3576 | Генерация соседних cfg (содержит `mutate()`) |
| `runHillClimbing` | 3707 | Главный HC алгоритм |
| `_hcOpenDetail` | 4464 | Открыть детальный вид из HC модала |
