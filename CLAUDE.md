...
- `generatePineStrategy` (1908) — экспорт Pine стратегии (strategy.exit)
- `fixPineScript` (1917) — автоисправление Pine v5→v6
- `_addActivePinev6` (2033) — toggle-группы Pine v6
