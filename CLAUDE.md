...
- `_calcIndicators` (3431) — пересчёт MA, ATR и др.
- `runOpt` (937) — главный цикл (MC/TPE/Ex)
- `_runOOS` (996) — OOS прогон
- `_attachOOS` (1011) — IS/OOS split
- `buildBtCfg` (3805) — сборка cfg для бэктеста
- `runMassRobust` (4061) — массовый тест устойчивости
- `HC_NUMERIC_PARAMS` (4381) — список параметров HC
