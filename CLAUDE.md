...
- `_calcIndicators` (3578) — пересчёт MA, ATR и др.
- `runOpt` (967) — главный цикл (MC/TPE/Ex)
- `_runOOS` (1030) — OOS прогон
- `_attachOOS` (1045) — IS/OOS split
- `buildBtCfg` (3953) — сборка cfg для бэктеста
- `runMassRobust` (4214) — массовый тест устойчивости
- `HC_NUMERIC_PARAMS` (4534) — список параметров HC
