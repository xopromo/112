...
| `_calcIndicators` | 2159 | Вычисляет индикаторы по DATA |
| `buildBtCfg` | 2461 | Строит конфиг бэктеста из cfg+ind |
| `runMassRobust` | 2652 | Массовый тест устойчивости |
| `runRobustScoreFor` | 2718 | Тест устойчивости для одного результата |
| `runRobustScoreForDetailed` | 2885 | То же, но с деталями по каждому тесту |
| `HC_NUMERIC_PARAMS` | 2951 | Единый список числовых параметров HC |
...
| Функция | Строка | Описание |
|---------|--------|----------|
| `backtest` | 328 | Основной бэктест-цикл |
