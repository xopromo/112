...
| `_hcNeighbours` | 3425 | Генерация соседних cfg (содержит `mutate()`) |
| `runHillClimbing` | 3556 | Главный HC алгоритм |
| `_hcOpenDetail` | 4298 | Открыть детальный вид из HC модала |
