...
- `generatePineStrategy` (1797) — экспорт Pine стратегии (strategy.exit)
- `fixPineScript` (1806) — автоисправление Pine v5→v6
- `_addActivePinev6` (1922) — toggle-группы Pine v6
