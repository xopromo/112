...
function generatePineScript(r) {
  ...
  lines.push(`    secs < 60 ? str.tostring(secs) + "S" : secs < 3600 ? str.tostring(math.round(secs / 60)) : secs < 86400 ? str.tostring(math.round(secs / 3600)) + "H" : str.tostring(math.round(secs / 86400)) + "D"`);
