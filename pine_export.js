...
function generatePineScript(r) {
  ...
  lines.push(`tl_pv_l      = input.int(${c.tlPvL||5},  "TL Pivot Left",  minval=2, maxval=20, group=grp_entry)`);
  lines.push(`tl_pv_r      = input.int(${c.tlPvR||3},  "TL Pivot Right", minval=1, maxval=10, group=grp_entry)`);
