...
function generatePineScript(r, mode = 'indicator') {
  ...
  // ##FLAT_EXIT## FlatBreak entry — пробой из флэт-зоны
  lines.push(`bool fz_break_l = use_flat_br and fz_streak[2] >= fz_min_flat and fz_streak[1] < fz_min_flat and (not fz_br_confirm or close[1] > open[1])`);
  lines.push(`bool fz_break_s = use_flat_br and fz_streak[2] >= fz_min_flat and fz_streak[1] < fz_min_flat and (not fz_br_confirm or close[1] < open[1])`);
  lines.push(``);
  lines.push(`bool pat_l = pivot_l or (use_engulf and bull_engulf[1]) or (use_pinbar and bull_pin[1]) or donch_l or boll_l or atr_bo_l or (use_ma_touch and ma_touch_l) or tl_touch_l or tl_break_l or flag_l or tri_l or rsix_l or macr_l or free_l or macd_l or stx_l or volmv_l or inb_l or nrev_l or st_l or sqz_l or kalman_x_l or pchg_l or soldiers_l or fz_break_l`);
