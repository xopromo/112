...
function _checkMSCConfig() {
  ...
  document.getElementById('msc-apply-btn').addEventListener('click', function() {
    ...
    const btn = document.getElementById('msc-apply-btn');
    if (btn) { btn.textContent = '✅ Применено'; btn.disabled = true; btn.style.opacity = '0.6'; }
    setTimeout(() => { const b = document.getElementById('msc-banner'); if (b) b.remove(); }, 1500);
  });
}
