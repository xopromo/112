...
async function runSynthesis() {
  ...
  try {
    ...
    // Use main thread runOpt() which has all the TPE, filtering, and OOS fixes
    console.log('[synthesis] Using main thread runOpt() with optMode=synthesis');
    await runOpt();

    // After runOpt() completes, close the modal so user sees results
    closeSynthesisModal();
